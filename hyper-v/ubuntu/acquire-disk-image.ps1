...
.NOTES
    ...
    Exports two functions:
      Invoke-BaseImagePatch       - patches cloud-init datasource in a base VHDX
      Invoke-DiskImageAcquisition - full disk acquisition pipeline for one VM
#>
...
function Invoke-DiskImageAcquisition {
    ...
    # See Invoke-BaseImagePatch above for full implementation details.
    # ------------------------------------------------------------------
